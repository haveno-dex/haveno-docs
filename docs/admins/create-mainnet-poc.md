...
For a more robust and decentralized deployment to VPS for reliable uptime, see the [deployment guide](https://github.com/haveno-dex/haveno/blob/master/docs/deployment-guide.md).
...
The price node is separated from Haveno and is run as a standalone service. To deploy a pricenode on both TOR and clearnet, see the instructions on the repository: [https://github.com/haveno-dex/haveno-pricenode](https://github.com/haveno-dex/haveno-pricenode).
...
However a [more robust VPS setup](https://github.com/haveno-dex/haveno/blob/master/docs/deployment-guide.md) should be used for actual trades.
