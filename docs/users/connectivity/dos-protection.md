...
If your application is under sustained Denial of Service (DoS) attack, binding to a [hardened Tor](./hardened-tor.md) instance is highly recommended to resolve most issues.
